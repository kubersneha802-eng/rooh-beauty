...
const FOUNDATION_GROUPS = [
  ...
  },
  {
    ...
    shades: [
      { name: "Matcha Soft Hour", code: "O-01", depth: "fair", color: "#EED0AE" },
      { name: "Green Flag Glow", code: "O-02", depth: "light", color: "#DEB88A" },
      { name: "Guac Is Extra", code: "O-03", depth: "light-med", color: "#C49A6C" },
      { name: "Olive You So Much", code: "O-04", depth: "medium", color: "#A07845" },
      { name: "Plot Armor Bronze", code: "O-05", depth: "med-deep", color: "#7E5C2C" },
      { name: "Earthy & That Girl", code: "O-06", depth: "deep", color: "#5A3C18" },
      { name: "Rooted & Radiant", code: "O-07", depth: "rich", color: "#402A10" },
      { name: "Deep Olive Energy", code: "O-08", depth: "ultra deep", color: "#30200A" },
      { name: "Mother Earth Slay", code: "O-09", depth: "deepest", color: "#221606" },
      { name: "Ancient & Iconic", code: "O-10", depth: "ultra rich", color: "#160E04" },
    ],
  },
];
