...
const FOUNDATION_GROUPS = [
  {
    ...
    shades: [
      { name: "Iced Oat Milk", code: "C-01", depth: "fair", color: "#BE9484" },
      { name: "Frozen Latte", code: "C-02", depth: "light", color: "#A37E71" },
      { name: "Cold Brew Swirl", code: "C-03", depth: "light-med", color: "#8D6E62" },
      { name: "Chilly Caramel", code: "C-04", depth: "medium", color: "#7B6056" },
      { name: "Arctic Truffle", code: "C-05", depth: "med-deep", color: "#695249" },
      { name: "Frosted Mahogany", code: "C-06", depth: "deep", color: "#57443D" },
      { name: "Midnight Espresso", code: "C-07", depth: "rich", color: "#453630" },
      { name: "Unbothered & Dark", code: "C-08", depth: "ultra deep", color: "#332824" },
      { name: "Deep & Iconic", code: "C-09", depth: "deepest", color: "#241C19" },
      { name: "The Final Boss", code: "C-10", depth: "ultra rich", color: "#1B1513" },
    ],
  },
  {
    ...
    shades: [
      { name: "Oat Latte Rush", code: "W-01", depth: "fair", color: "#D0B072" },
      { name: "Golden Hour Glow", code: "W-02", depth: "light", color: "#B29761" },
      { name: "Brunch Drip", code: "W-03", depth: "light-med", color: "#9B8455" },
      { name: "Main Character Bronze", code: "W-04", depth: "medium", color: "#87734A" },
      { name: "Netflix & Glow", code: "W-05", depth: "med-deep", color: "#73623F" },
      { name: "Espresso Slay", code: "W-06", depth: "deep", color: "#605134" },
      { name: "Rich & Petty", code: "W-07", depth: "rich", color: "#4C402A" },
      { name: "Warm Chaos Energy", code: "W-08", depth: "ultra deep", color: "#38301F" },
      { name: "Sunkissed & Done", code: "W-09", depth: "deepest", color: "#282216" },
      { name: "That Glow Though", code: "W-10", depth: "ultra rich", color: "#1E1910" },
    ],
  },
  {
    ...
    note: "Balanced",
    shades: [
      { name: "Monday, Ugh", code: "N-01", depth: "fair", color: "#C6A77B" },
      { name: "Soft Launch Skin", code: "N-02", depth: "light", color: "#AA8F69" },
      { name: "Situationship Beige", code: "N-03", depth: "light-med", color: "#947D5C" },
      { name: "Hired (Finally)", code: "N-04", depth: "medium", color: "#816D50" },
      { name: "Plot Twist Tan", code: "N-05", depth: "med-deep", color: "#6E5D44" },
      { name: "No Filter Needed", code: "N-06", depth: "deep", color: "#5B4D39" },
      { name: "Literally Flawless", code: "N-07", depth: "rich", color: "#483D2D" },
      { name: "Chronically Radiant", code: "N-08", depth: "ultra deep", color: "#362D21" },
      { name: "Do Not Edit", code: "N-09", depth: "deepest", color: "#262017" },
      { name: "Unfiltered & Winning", code: "N-10", depth: "ultra rich", color: "#1C1812" },
    ],
  },
  {
    ...
    shades: [
      { name: "Matcha Soft Hour", code: "O-01", depth: "fair", color: "#CDB574" },
      { name: "Green Flag Glow", code: "O-02", depth: "light", color: "#B09B64" },
      { name: "Guac Is Extra", code: "O-03", depth: "light-med", color: "#998757" },
      { name: "Olive You So Much", code: "O-04", depth: "medium", color: "#85764C" },
      { name: "Plot Armor Bronze", code: "O-05", depth: "med-deep", color: "#726441" },
      { name: "Earthy & That Girl", code: "O-06", depth: "deep", color: "#5E5336" },
      { name: "Rooted & Radiant", code: "O-07", depth: "rich", color: "#4B422A" },
      { name: "Deep Olive Energy", code: "O-08", depth: "ultra deep", color: "#37311F" },
      { name: "Mother Earth Slay", code: "O-09", depth: "deepest", color: "#272216" },
      { name: "Ancient & Iconic", code: "O-10", depth: "ultra rich", color: "#1D1A11" },
    ],
  },
];
