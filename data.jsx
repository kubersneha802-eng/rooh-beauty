/* ============================================================
   ...
   Foundation: 40 shades · 4 undertone families
...
const FOUNDATION_GROUPS = [
  {
    ...
    shades: [
      { name: "Iced Oat Milk", code: "C-01", depth: "fair", color: "#F4DECB" },
      { name: "Frozen Latte", code: "C-02", depth: "light", color: "#EBD0B4" },
      { name: "Cold Brew Swirl", code: "C-03", depth: "light-med", color: "#D7B492" },
      { name: "Chilly Caramel", code: "C-04", depth: "medium", color: "#B07F54" },
      { name: "Arctic Truffle", code: "C-05", depth: "med-deep", color: "#8A5A35" },
      { name: "Frosted Mahogany", code: "C-06", depth: "deep", color: "#5A3621" },
      { name: "Midnight Espresso", code: "C-07", depth: "rich", color: "#3C2417" },
      { name: "Unbothered & Dark", code: "C-08", depth: "ultra deep", color: "#2A1810" },
      { name: "Deep & Iconic", code: "C-09", depth: "deepest", color: "#20110A" },
      { name: "The Final Boss", code: "C-10", depth: "ultra rich", color: "#160B06" },
    ],
  },
  {
    ...
    shades: [
      { name: "Oat Latte Rush", code: "W-01", depth: "fair", color: "#F1D8B2" },
      { name: "Golden Hour Glow", code: "W-02", depth: "light", color: "#EBCA92" },
      { name: "Brunch Drip", code: "W-03", depth: "light-med", color: "#D6A468" },
      { name: "Main Character Bronze", code: "W-04", depth: "medium", color: "#BC8246" },
      { name: "Netflix & Glow", code: "W-05", depth: "med-deep", color: "#965E30" },
      { name: "Espresso Slay", code: "W-06", depth: "deep", color: "#6E4420" },
      { name: "Rich & Petty", code: "W-07", depth: "rich", color: "#492B13" },
      { name: "Warm Chaos Energy", code: "W-08", depth: "ultra deep", color: "#371F0F" },
      { name: "Sunkissed & Done", code: "W-09", depth: "deepest", color: "#28160B" },
      { name: "That Glow Though", code: "W-10", depth: "ultra rich", color: "#1A0E06" },
    ],
  },
  {
    ...
    note: "Balanced",
    shades: [
      { name: "Monday, Ugh", code: "N-01", depth: "fair", color: "#EFD8BA" },
      { name: "Soft Launch Skin", code: "N-02", depth: "light", color: "#E2C399" },
      { name: "Situationship Beige", code: "N-03", depth: "light-med", color: "#C99E6F" },
      { name: "Hired (Finally)", code: "N-04", depth: "medium", color: "#A06E3C" },
      { name: "Plot Twist Tan", code: "N-05", depth: "med-deep", color: "#82532B" },
      { name: "No Filter Needed", code: "N-06", depth: "deep", color: "#56371F" },
      { name: "Literally Flawless", code: "N-07", depth: "rich", color: "#3D2613" },
      { name: "Chronically Radiant", code: "N-08", depth: "ultra deep", color: "#2D1B0E" },
      { name: "Do Not Edit", code: "N-09", depth: "deepest", color: "#1E1108" },
      { name: "Unfiltered & Winning", code: "N-10", depth: "ultra rich", color: "#150B05" },
    ],
  },
  {
    ...
    shades: [
      { name: "Matcha Soft Hour", code: "O-01", depth: "fair", color: "#E3D2A4" },
      { name: "Green Flag Glow", code: "O-02", depth: "light", color: "#D2BB80" },
      { name: "Guac Is Extra", code: "O-03", depth: "light-med", color: "#A68E55" },
      { name: "Olive You So Much", code: "O-04", depth: "medium", color: "#867033" },
      { name: "Plot Armor Bronze", code: "O-05", depth: "med-deep", color: "#6B5727" },
      { name: "Earthy & That Girl", code: "O-06", depth: "deep", color: "#382C12" },
      { name: "Rooted & Radiant", code: "O-07", depth: "rich", color: "#2C220F" },
      { name: "Deep Olive Energy", code: "O-08", depth: "ultra deep", color: "#221A0A" },
      { name: "Mother Earth Slay", code: "O-09", depth: "deepest", color: "#1A1308" },
      { name: "Ancient & Iconic", code: "O-10", depth: "ultra rich", color: "#120D05" },
    ],
  },
];
...
const PRODUCTS = [
  {
    ...
    shadeCount: "40 shades · 4 undertones",
    shadeNoun: "shade",
    ...
    benefits: [
      ...
      { title: "40 honest shades", body: "Cool, warm, neutral, and olive undertones from fair to ultra-rich — matched on real skin." },
    ],
    actives_detail: [
