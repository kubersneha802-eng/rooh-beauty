/* ============================================================
   ...
   Foundation: 15 shades · 4 undertone families
   Concealer:  11 shades (cover / hi-lite / contour) + 4 correctors
   Lip:        11 shades · 3 colour families
   ============================================================ */
...
const FOUNDATION_HERO = [
  FOUNDATION_GROUPS[1].shades[0], // Oat Latte Rush   (W-01)
  FOUNDATION_GROUPS[2].shades[0], // Soft Launch Skin  (N-02)
  FOUNDATION_GROUPS[1].shades[2], // Brunch Drip       (W-03)
  FOUNDATION_GROUPS[2].shades[2], // Hired (Finally)   (N-04)
  FOUNDATION_GROUPS[1].shades[4], // Netflix & Glow    (W-05)
  FOUNDATION_GROUPS[0].shades[2], // Frosted Mahogany  (C-06)
];
const CONCEALER_HERO = [
  CONCEALER_GROUPS[0].shades[0],  // CC-02
  CONCEALER_GROUPS[0].shades[2],  // CC-04
  CONCEALER_GROUPS[0].shades[5],  // CC-07
  COLOR_CORRECTORS[0],
  COLOR_CORRECTORS[1],
  COLOR_CORRECTORS[2],
];
...
const PRODUCTS = [
  {
    ...
    shadeCount: "15 shades · 4 undertones",
    shadeNoun: "shade",
    ...
    benefits: [
      ...
      { title: "15 honest shades", body: "Cool, warm, neutral, and olive undertones from fair to deep — matched on real South Asian skin." },
    ],
    actives_detail: [
  ...
  },
  {
    ...
    longDesc:
      "A full-coverage concealer that doubles as a brightening treatment. Lays down opaque, crease-proof color over dark circles, blemishes, and post-acne marks — then keeps working with stable vitamin C and zinc PCA. Pair the 6 cover shades with 4 colour correctors to neutralize anything skin throws at you.",
    price: 20,
    finish: "Soft-matte",
    coverage: "Full · crease-proof",
    size: "8 ml / 0.27 fl oz",
    actives: ["Vit C (SAP)", "Zinc PCA", "Peptides"],
    shadeCount: "11 shades + 4 correctors",
    shadeNoun: "shade",
