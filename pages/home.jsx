      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          ...
          <div className="product-teaser-grid">
            <Teaser tone="" label="Foundation · 24hr wear" name="Skin-Forward Foundation" shadeCount="28 shades · sensitive skin" price="$26" shades={FOUNDATION_SHADES} onClick={() => setPage("product", "foundation")} delay="0ms" />
