      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          ...
          <div className="product-teaser-grid">
            ...
            <Teaser tone="g3" label="Lip · Treatment Gloss" name="Glow & Go Lip Treatment" shadeCount="9 shades · peptides" price="$18" shades={LIP_SHADES} onClick={() => setPage("product", "lip")} delay="240ms" />
          </div>
        </div>
      </section>
